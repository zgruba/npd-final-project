import argparse
from cinematic_impact_package.lib import hello, load_data, weak_impact, MovieFilter, geopolitical_data, impact_vs_data, split_star_countries, strong_impact, create_representation, get_top_countries, movies_quality
